...
class SON_Taxonomy
{
    ...
    protected function labels()
    {
        $default = array(
            ...
            'add_or_remove_items'        => sprintf(__('Add or Remove %ss', 'son'), $this->name),
            'view_item'                  => sprintf(__('View %s', 'son'), $this->name),
            'edit_item'                  => sprintf(__('Edit %s', 'son'), $this->name),
            'search_items'               => sprintf(__('Search %s', 'son'), $this->name),
            'update_item'                => sprintf(__('Update %s', 'son'), $this->name),
            'parent_item'                => sprintf(__('Parent %s:', 'son'), $this->name),
            'parent_item_colon'          => sprintf(__('Parent %s:', 'son'), $this->name),
            'menu_name'                  => sprintf(__('%ss', 'son'), $this->name),
            'add_new_item'               => sprintf(__('Add New %s', 'son'), $this->name),
            'new_item_name'              => sprintf(__('New %s', 'son'), $this->name),
            'all_items'                  => sprintf(__('All %ss', 'son'), $this->name),
            'separate_items_with_commas' => sprintf(__('Separate %ss with comma', 'son'), $this->name),
            'choose_from_most_used'      => sprintf(__('Choose from %ss most used', 'son'), $this->name)
        );
